function [tfr, tfrtic, sqPsift] = CWT(t, x, opts)
%
...
% %         windowq = windowq ./ sqrt(qscale);
%         
%         sqPsift(kscale,:) = windowq.'; %%% non-conjugate transpose
%         
%         what = windowq .* xhat;
%         
%         w = ifft(what);
...
% function [peakAF, peakCF] = morsePeakFrq(ga,be,k)
% 
% if k > 0
%     error('TODO: calculate peak frequency for k~=0');
% end
% 
